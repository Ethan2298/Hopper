...
const inkLight = EditorView.theme(
  {
    "&": { backgroundColor: "#faf8f5", color: "#2d2d2a" },
    ".cm-content": { caretColor: "#1a1a18" },
    ".cm-cursor, .cm-dropCursor": { borderLeftColor: "#1a1a18" },
    "&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": {
      backgroundColor: "#d4cfc6",
    },
    ".cm-panels": { backgroundColor: "#f0ede8", color: "#2d2d2a" },
    ".cm-panels.cm-panels-top": { borderBottom: "1px solid #e0dcd5" },
    ".cm-panels.cm-panels-bottom": { borderTop: "1px solid #e0dcd5" },
    ".cm-searchMatch": { backgroundColor: "#e8d8c0", outline: "1px solid #d0c4a8" },
    ".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: "#d4c4a0" },
    ".cm-activeLine": { backgroundColor: "#f0ede808" },
    ".cm-selectionMatch": { backgroundColor: "#e8dcc8" },
    "&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket": {
      backgroundColor: "#d4cfc6",
    },
    ".cm-gutters": { backgroundColor: "#f0ede8", color: "#999590", borderRight: "1px solid #e0dcd5" },
    ".cm-activeLineGutter": { backgroundColor: "#e8e4dd" },
    ".cm-foldPlaceholder": { backgroundColor: "transparent", border: "none", color: "#999590" },
    ".cm-tooltip": { border: "1px solid #e0dcd5", backgroundColor: "#f0ede8" },
    ".cm-tooltip .cm-tooltip-arrow:before": { borderTopColor: "transparent", borderBottomColor: "transparent" },
    ".cm-tooltip .cm-tooltip-arrow:after": { borderTopColor: "#f0ede8", borderBottomColor: "#f0ede8" },
    ".cm-tooltip-autocomplete": { "& > ul > li[aria-selected]": { backgroundColor: "#e8e4dd", color: "#1a1a18" } },
  },
  { dark: false }
)
...
const inkDark = EditorView.theme(
  {
    "&": { backgroundColor: "#181816", color: "#c4c0b8" },
    ".cm-content": { caretColor: "#c4c0b8" },
    ".cm-cursor, .cm-dropCursor": { borderLeftColor: "#c4c0b8" },
    "&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": {
      backgroundColor: "#2a2924",
    },
    ".cm-panels": { backgroundColor: "#131311", color: "#c4c0b8" },
    ".cm-panels.cm-panels-top": { borderBottom: "1px solid #2a2924" },
    ".cm-panels.cm-panels-bottom": { borderTop: "1px solid #2a2924" },
    ".cm-searchMatch": { backgroundColor: "#3a3420", outline: "1px solid #4a4430" },
    ".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: "#4a4430" },
    ".cm-activeLine": { backgroundColor: "#1e1e1a08" },
    ".cm-selectionMatch": { backgroundColor: "#2e2a20" },
    "&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket": {
      backgroundColor: "#2a2924",
    },
    ".cm-gutters": { backgroundColor: "#131311", color: "#666358", borderRight: "1px solid #2a2924" },
    ".cm-activeLineGutter": { backgroundColor: "#1e1e1a" },
    ".cm-foldPlaceholder": { backgroundColor: "transparent", border: "none", color: "#666358" },
    ".cm-tooltip": { border: "1px solid #2a2924", backgroundColor: "#131311" },
    ".cm-tooltip .cm-tooltip-arrow:before": { borderTopColor: "transparent", borderBottomColor: "transparent" },
    ".cm-tooltip .cm-tooltip-arrow:after": { borderTopColor: "#131311", borderBottomColor: "#131311" },
    ".cm-tooltip-autocomplete": { "& > ul > li[aria-selected]": { backgroundColor: "#1e1e1a", color: "#c4c0b8" } },
  },
  { dark: true }
)
