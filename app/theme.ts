...
/** CodeMirror dark theme — matches Magi surface. */
const inkDark = EditorView.theme(
  {
    "&": { backgroundColor: "#171717", color: "#f7f8f8" },
    ".cm-content": { caretColor: "#f7f8f8" },
    ".cm-cursor, .cm-dropCursor": { borderLeftColor: "#f7f8f8" },
    "&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": {
      backgroundColor: "rgba(1, 105, 204, 0.25)",
    },
    ".cm-panels": { backgroundColor: "#17181b", color: "#f7f8f8" },
    ".cm-panels.cm-panels-top": { borderBottom: "1px solid #1e1e1e" },
    ".cm-panels.cm-panels-bottom": { borderTop: "1px solid #1e1e1e" },
    ".cm-searchMatch": { backgroundColor: "rgba(1, 105, 204, 0.25)", outline: "1px solid rgba(1, 105, 204, 0.5)" },
    ".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: "rgba(1, 105, 204, 0.5)" },
    ".cm-activeLine": { backgroundColor: "rgba(255, 255, 255, 0.03)" },
    ".cm-selectionMatch": { backgroundColor: "rgba(1, 105, 204, 0.18)" },
    "&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket": {
      backgroundColor: "rgba(255, 255, 255, 0.08)",
    },
    ".cm-gutters": { backgroundColor: "#171717", color: "#8a8f98", borderRight: "1px solid #1e1e1e" },
    ".cm-activeLineGutter": { backgroundColor: "rgba(255, 255, 255, 0.04)" },
    ".cm-foldPlaceholder": { backgroundColor: "transparent", border: "none", color: "#8a8f98" },
    ".cm-tooltip": { border: "1px solid rgba(255,255,255,0.08)", backgroundColor: "#17181b" },
    ".cm-tooltip .cm-tooltip-arrow:before": { borderTopColor: "transparent", borderBottomColor: "transparent" },
    ".cm-tooltip .cm-tooltip-arrow:after": { borderTopColor: "#17181b", borderBottomColor: "#17181b" },
    ".cm-tooltip-autocomplete": { "& > ul > li[aria-selected]": { backgroundColor: "rgba(255,255,255,0.08)", color: "#f7f8f8" } },
  },
  { dark: true }
)
...
function badge(label: string, bg: string, fg: string): string {
  return `<svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="2" width="13" height="10" rx="2" fill="${bg}"/><text x="7" y="9.5" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-size="7" font-weight="700" fill="${fg}">${label}</text></svg>`
}
